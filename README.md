# 🧩 PropConX – Node-RED Integration Templates

## Overview

This repository contains **public, reference-grade Node-RED integration templates** maintained by **PropConX**.
...
The purpose of this repository is to provide **clear, inspectable examples** of how PropConX integrates with
common building management and control system platforms.

These templates are intended for:
- Partners implementing PropConX-compatible integrations
- Customers running PropConX on edge devices
